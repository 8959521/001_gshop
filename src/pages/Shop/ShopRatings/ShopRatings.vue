  ...
  <div class="ratings" ref="ratings">
    <div class="ratings-content">
      ...
      <div class="ratingselect">
        ...
        <div class="switch " :class="{on: isShowText}" @click="toggleIsShow">
        ...
        <ul>
          <li class="rating-item" v-for="(rating, index) in filterRatings" :key="index">
            ...
            <div class="content">
              ...
              <div class="recommend">
                <span class="iconfont " :class="rating.rateType==0?'icon-thumb_up':'icon-thumb-down' "></span>
	...
	import {mapState,mapGetters} from 'vuex'
  	export default {
  		...
  		computed: {
  			...
  			filterRatings () {
  				const {selectType, ratings, isShowText} = this
  				return ratings.filter(rating => {
  					const {rateType, Text} = rating
  					return (selectType==2 || rateType==selectType) && (isShowText || Text.length>0)
  				})
  			}
  		},
  		mounted () {
  			this.$store.dispatch('getShopRatings', ()=>{
  				this.$nextTick(() => {
  					const bbs = new BScroll(this.$refs.ratings,{
  						click:true
  					})
  					bbs.refresh()
  				})
